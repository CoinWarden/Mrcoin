The following is a list of assets used in the Mrcoin source and their proper attribution.
...
* License: MIT
* Site: [https://Mrcointalk.org/index.php?topic=15276.0](https://Mrcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original Mrcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/Mrcoin.icns, src/qt/res/src/Mrcoin.svg,
	src/qt/res/src/Mrcoin.ico, src/qt/res/src/Mrcoin.png,
	src/qt/res/src/Mrcoin_testnet.png, docs/Mrcoin_logo_doxygen.png,
