...
*Setup instructions for a gitian build of Mrcoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Mrcoin
...
- [Building Mrcoin](#building-Mrcoin)
...
Clone the git repositories for Mrcoin and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/Mrcoin/Mrcoin
```
...
In [doc/release-process.md](release-process.md) in the Mrcoin repository under 'Fetch and build inputs'.
...
To build Mrcoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the Mrcoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/Mrcoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/Mrcoin/Mrcoin
...
For example:
```bash
URL=https://github.com/laanwj/Mrcoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit Mrcoin=${COMMIT} --url Mrcoin=${URL} ../Mrcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit Mrcoin=${COMMIT} --url Mrcoin=${URL} ../Mrcoin/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/Mrcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/Mrcoin-build.assert
```
...
[Mrcoin/gitian.sigs](https://github.com/Mrcoin/gitian.sigs/) repository, or
