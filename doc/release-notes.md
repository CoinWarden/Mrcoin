Mrcoin Core version 0.9.4 is now available from:

  https://Mrcoin.org/bin/0.9.4/
...
installer (on Windows) or just copy over /Applications/Mrcoin-Qt (on Mac) or
Mrcoind/Mrcoin-qt (on Linux).
...
this update is incompatible with the Mrcoin system and could lead to consensus
forks.

Mrcoin Core released binaries from https://Mrcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~Mrcoin/+archive/ubuntu/Mrcoin
- A third-party or self-compiled Mrcoin Core

upgrade to Mrcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/Mrcoin/).
