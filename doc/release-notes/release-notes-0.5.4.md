Mrcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/Mrcoin/files/Mrcoin/Mrcoin-0.5.4/
...
http://gitorious.org/Mrcoin/Mrcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Mrcoin-Qt notifications under Growl 1.3.
Increase required age of Mrcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMrcoin properly when installing Mrcoin-Qt over it. (Windows)
