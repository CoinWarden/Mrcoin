Mrcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/Mrcoin/files/Mrcoin/Mrcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Mrcoin
...
New/changed settings (command-line or Mrcoin.conf file)
--------------------------------------------------------
