#!/usr/bin/python
# Copyright (c) 2013 The Mrcoin Core developers
...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old MrcoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/MrcoindComparisonTool_jar/MrcoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/Mrcoin/Mrcoin.git")
...
environ_default("BUILD_PATH", "/mnt/Mrcoin")
...
environ_default("GITHUB_REPO", "Mrcoin/Mrcoin")
