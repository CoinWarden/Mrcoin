...
unlocked to sign the Mrcoin-Qt.app bundle.
...
allowing somebody to distribute a Mrcoin-Qt.app or Mrcoin-qt-setup.exe with a valid
...
that the Mrcoin-qt.exe file inside the installer had not been tampered with.
