...
public:
    CMainParams() {
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1466545481;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 218325099;

        hashGenesisBlock = genesis.GetHash();
        //vSeeds.push_back(CDNSSeedData("Mrcoin.sipa.be", "seed.Mrcoin.sipa.be"));
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1468895481;
        genesis.nNonce = 218725099;
        hashGenesisBlock = genesis.GetHash();
        vFixedSeeds.clear();
        vSeeds.clear();
