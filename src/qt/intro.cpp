...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/Mrcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Mrcoin"),
     ...
     * override -datadir in the Mrcoin.conf file in the default data directory
     * (to be consistent with Mrcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
